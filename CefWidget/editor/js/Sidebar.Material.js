...
//	} ) );
	...
	managerRow.add( new UI.Button( '复制材质' ).setMarginLeft( '4px' ).onClick( function () {
	...
	managerRow.add( new UI.Button( '粘贴材质' ).setMarginLeft( '4px' ).onClick( function () {
	...
	materialNameRow.add( new UI.Text( '材质名称' ).setWidth( '90px' ) );
	...
	materialMapRow.add( new UI.Text( '颜色贴图' ).setWidth( '90px' ) );
	...
	materialAlphaMapRow.add( new UI.Text( '透明贴图' ).setWidth( '90px' ) );
	...
	materialDisplacementMapRow.add( new UI.Text( '置换贴图' ).setWidth( '90px' ) );
	...
	materialRoughnessMapRow.add( new UI.Text( '粗糙度贴图' ).setWidth( '90px' ) );
	...
	materialMetalnessMapRow.add( new UI.Text( '金属度贴图' ).setWidth( '90px' ) );
	...
	materialSpecularMapRow.add( new UI.Text( '反射贴图' ).setWidth( '90px' ) );
	...
	materialLightMapRow.add( new UI.Text( '灯照贴图' ).setWidth( '90px' ) );
...
//	var materialWireframeLinewidth = new UI.Number( 1 ).setWidth( '60px' ).setRange( 0, 100 ).onChange( update );
	...
	materialWireframeRow.add( new UI.Text( '线框模式' ).setWidth( '90px' ) );
